 ...
 */
const trimChar = function (string, pattern) {
 ...
 * @returns {string} str
 */
const arrayReplaceSingle = function (string, patternArray, replacement) {
    if (typeof string.toString === 'undefined') {
 ...
 * @returns {Array | null}
 */
const languageSpecificCharsArray = function (language) {
 ...
 * @returns {string | * | void}
 */
const ascii = function (string, language = 'en') {
    if (typeof language.toString === 'undefined') {
        throw new Error('language parameter must be a string or castable to string');
    }
 ...
 * @returns {string | *}
 */
module.exports = function (string, separator = '-', language = 'en') {
    ...
    str = str.toLowerCase();
    str = str.replace('/[' + separator + '\s]/g', separator);
    str = trimChar(str, '-');
    str = str.replace(/ +/gi, '-').replace(/[^a-z0-9-]/g, '');
